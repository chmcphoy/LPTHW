...
# add some more cites
cities['NY'] = "New York" # Put this example in ANKI!!
cities['OR'] = "Portland"
...
states['Texas'] = "TX" # Testing to add abbrev
print "Texas is abbreviated as: ", states['Texas'] # Testing to run

if not state:
    print "Sorry, no Texas." # To add: states['Texas'] = "TX"
